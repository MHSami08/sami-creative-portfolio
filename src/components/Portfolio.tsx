...
const Portfolio = () => {
  ...
  const projects = [
    {
      ...
      thumbnail: "https://i.imgur.com/4KdnBL4.jpeg",
    ...
    },
    {
      ...
      isPortrait: true,  // 9:16 portrait video
    },
    {
      id: 3,
  ...
  const handleProjectClick = (project: typeof projects[0]) => {
    if (project.status === 'completed' && project.videoUrl) {
      setSelectedVideo({ url: project.videoUrl, title: project.title, isPortrait: project.isPortrait });
    }
  };
  ...
  return (
    <section className="py-12 sm:py-20 bg-background" id="portfolio">
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <span
                      className={`inline-block px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium ${getStatusColor(project.status)}`}
                    >
      ...
      <VideoPlayer
        ...
        isPortrait={selectedVideo?.isPortrait || false}
      />
    </section>
  );
};
