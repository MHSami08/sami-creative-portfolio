    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-8 animate-fade-in">
            ...
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500/10 to-amber-500/10 rounded-full border border-blue-400/30 backdrop-blur-lg shadow-lg shadow-blue-500/10">
                ...
                <p className="text-blue-400 dark:text-blue-300 font-amiri text-lg font-bold">بسم الله الرحمن الرحيم</p>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <p className="text-blue-400 dark:text-blue-300 text-xl md:text-2xl font-amiri font-medium">السلام عليكم</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button 
                ...
                className="group bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-8 py-4 text-lg rounded-xl font-semibold shadow-xl shadow-blue-500/25 hover:shadow-2xl hover:shadow-blue-500/40 transition-all duration-300 hover:scale-105 border border-blue-400/30"
              >
          ...
          {/* Enhanced Profile Picture Section with closer floating elements and green glow */}
